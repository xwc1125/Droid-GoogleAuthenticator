...
public class Base32Utils {
    ...
    private static final Base32Utils INSTANCE =
            new Base32Utils("ABCDEFGHIJKLMNOPQRSTUVWXYZ234567"); // RFC 4648/3548

    static Base32Utils getInstance() {
        return INSTANCE;
    }
    ...
    protected Base32Utils(String alphabet) {
